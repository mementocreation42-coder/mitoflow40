        ...
        <div className="pt-[calc(60px+3rem)] md:pt-[calc(60px+6rem)] pb-12 md:pb-24 px-6 md:px-4 min-h-screen relative overflow-hidden" style={{ background: '#E3E8DF' }}>
            ...
            <article className="max-w-[820px] mx-auto relative" style={{ zIndex: 1 }}>
                ...
                <section className="mb-10 bg-white/70 rounded-2xl p-6 md:p-8 border border-black">
                    ...
                    <p className="text-[#4A4A4A] leading-loose whitespace-pre-line">
                        日本は、世界の合法化の流れとは逆に、規制を<strong>強める</strong>方向を選びました。2024年12月の法改正で、大麻の不正な「<strong>使用</strong>」そのものが新たに罪となり（使用罪）、所持の罰則も強化されました。大麻のTHCは「麻薬」として扱われます<sup className="text-[#FF9855] font-bold">[3]</sup>。
                        {'\n\n'}
                        一方で、同じ改正にはもう一つの側面があります。それまで認められなかった大麻由来の「<strong>医薬品</strong>」（難治性てんかんの治療薬など）が、医療の中で使えるようになったのです。「<strong>嗜好目的は厳しく禁じ、医療目的には道を開く</strong>」——これが、日本の方向性です。
                        {'\n\n'}
                        また、THCをごく微量しか含まない<strong>CBD製品</strong>は、定められた基準（THC残留限度値）を満たせば、日本でも合法に流通しています。規制が「部位」から「成分」へと移り変わったことが、近年の大きな変化です。
                    </p>
                </section>
