...
export const alt = '結果サンプル | ミトコンドリア・セルフチェック | Mitoflow40';
        ...
        (
            <div style={{
                ...
                <div style={{ fontSize: 88, fontWeight: 900, color: '#1A1A1A', lineHeight: 1.15, display: 'flex', flexDirection: 'column' }}>
                    <span>ミトコンドリア</span>
                    <span><span style={{ color: '#FF9855' }}>セルフチェック</span></span>
                    <span>結果の見本</span>
                </div>
                <div style={{ marginTop: 'auto', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
                    <div style={{ fontSize: 22, color: '#1A1A1A', display: 'flex', flexDirection: 'column' }}>
                        <span style={{ fontWeight: 700 }}>Archetype × 4軸スコア × AI解析</span>
                        <span style={{ fontSize: 18, color: '#4A4A4A', marginTop: 4 }}>どんな結果が出るかのデモ</span>
                    </div>
                    <div style={{ fontSize: 22, fontWeight: 700, color: '#1A1A1A', display: 'flex' }}>
                        mitoflow40.com/check/sample
                    </div>
                </div>
            </div>
        ),
