...
import MitoClimb from '@/components/game/MitoClimb';
...
export default function PlaySlowPage() {
    return (
        <div className="min-h-[100dvh] flex flex-col relative overflow-hidden" style={{ background: '#ECE6F3' }}>
            <div className="md:hidden flex flex-col flex-1">
                <div className="flex items-center justify-between px-4 py-2 w-full">
                    ...
                    <span className="text-[10px] font-bold tracking-widest text-[#4A4A4A]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>GAME · ゆっくり</span>
                </div>
            ...
            <div className="hidden md:flex flex-1 items-center justify-center relative">
                ...
                <div className="relative">
                    ...
                    <p className="absolute -bottom-8 left-0 right-0 text-center text-[11px] font-bold text-white/80" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>← → か クリックで うごく</p>
                </div>
            </div>
        </div>
    );
