    ...
    return (
        <div className="relative overflow-x-clip pt-[calc(60px+3rem)] md:pt-[calc(60px+6rem)] pb-12 md:pb-24 px-6 md:px-4 min-h-screen" style={{ background: '#ECE6F3' }}>
            ...
            <div className="max-w-[820px] mx-auto relative" style={{ zIndex: 1 }}>
                ...
                {/* 横断検索 ＋ ライブラリマップへの導線 */}
                <div className="my-6 md:my-12 flex flex-col sm:flex-row items-center justify-center gap-3 [&>div]:!my-0 [&>div]:!mx-0 [&>div]:w-full sm:[&>div]:w-auto">
                    <LibrarySearch />
                    <div className="flex w-full sm:w-auto gap-2 sm:gap-3 sm:contents">
                    <Link href="/library/map"
                        className="shrink-0 flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-3 sm:py-4 rounded-full bg-white border border-black text-sm font-bold text-[#1A1A1A] hover:bg-[#41C9B4] hover:text-white hover:border-[#41C9B4] transition-colors whitespace-nowrap">
                        🗺️ ライブラリマップ
                    </Link>
                    <Link href="/textbook"
                        className="shrink-0 flex-1 sm:flex-none inline-flex items-center justify-center gap-2 px-4 sm:px-5 py-3 sm:py-4 rounded-full bg-white border border-black text-sm font-bold text-[#1A1A1A] hover:bg-[#41C9B4] hover:text-white hover:border-[#41C9B4] transition-colors">
                        📖 教科書（読む順）
                    </Link>
                    </div>
                </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-1.5 md:gap-2.5">
                        {TOC.map((t) => (
                            <a key={t.href} href={t.href}
                                className="group inline-flex items-center gap-1 md:gap-2 px-3 md:px-4 py-1 md:py-2 rounded-full border text-[13px] md:text-[15px] font-bold text-[#1A1A1A] whitespace-nowrap shadow-sm bg-[var(--chip-bg)] hover:bg-[var(--chip)] hover:text-white transition-colors"
                    ...
                    {sections.map((s) => (
                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col p-4 pl-1 sm:p-5">
                                ...
                                <p className="flex-1 text-sm text-[#1A1A1A]/80 leading-relaxed mb-3 sm:mb-4 line-clamp-3 sm:line-clamp-none">{s.description}</p>
                ...
                <div id="mechanism" className="mt-10 md:mt-24 scroll-mt-24 md:scroll-mt-60">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <Link href="/molecular-nutrition#biochemistry"
                            ...
                            <p className="text-sm text-[#1A1A1A]/70 leading-relaxed line-clamp-2 sm:line-clamp-none">これから挙げる仕組みは、すべて「体の中の化学反応＝生化学」の話。栄養がなぜ効くのか、その土台をまず一言で。
                        ...
                        <Link href="/food-journey"
                            ...
                            <p className="text-sm text-[#1A1A1A]/70 leading-relaxed line-clamp-2 sm:line-clamp-none">食べる→消化→吸収→運搬→代謝→利用→排出。体の中で起きていることを、インフォグラフィックで一枚に俯瞰。
                                <span className="inline-block ml-1 font-bold text-[#1A1A1A] group-hover:translate-x-0.5 transition-transform">→</span>
                            </p>
                        </Link>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <Link href="/mitochondria"
                            ...
                            <div className="relative" style={{ zIndex: 1 }}>
                                ...
                                <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-3 sm:max-w-[80%] line-clamp-3 sm:line-clamp-none">すべての出発点。細胞のエネルギー工場とは何か、なぜ40代で重要か、どう元気に保つか。</p>
                        ...
                        <Link href="/energy"
                            ...
                            <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">疲れにくさの正体は「エネルギーを作り続けられること」。作るしくみと、その材料になる栄養までを、やさしく束ねる入口。</p>
                            <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                                見る <span className="group-hover:translate-x-1 transition-transform">→</span>
                            </span>
                        </Link>
                ...
                <div id="hormones" className="mt-10 md:mt-24 scroll-mt-24 md:scroll-mt-60">
                    ...
                    <Link href="/hormones"
                        ...
                        <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">テストステロン・エストロゲン・コルチゾール・インスリン・甲状腺ホルモンなど、主なホルモンを個別ページで解説。</p>
                        <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                            見る <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </span>
                    </Link>
                ...
                <div id="symptoms" className="mt-10 md:mt-24 scroll-mt-24 md:scroll-mt-60">
                    ...
                    <Link href="/symptoms"
                        ...
                        <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">疲れ・ブレインフォグ・冷え・動悸・めまい・むくみ・アレルギー・気分の落ち込みなどから、背景と打ち手を逆引き。</p>
                        <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                            見る <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </span>
                    </Link>
                ...
                <div id="conditions" className="mt-10 md:mt-12 scroll-mt-24">
                    <Link href="/conditions"
                        ...
                        <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">症状の裏にある<strong>病態</strong>の側から。鉄欠乏（隠れ貧血）・インスリン抵抗性・脂肪肝・更年期……定義・歴史・細胞レベルのしくみ・確認したい血液検査・受診の目安まで、1枚ずつ丁寧に。</p>
                        <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                            見る <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </span>
                    </Link>
                ...
                <div id="thoughts" className="mt-10 md:mt-24 scroll-mt-24 md:scroll-mt-60">
                    ...
                    <Link href="/thoughts"
                        ...
                        <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">運命とは？自由とは？老いるとは？幸せとは？——体の側から問いを見つめるエッセイ。</p>
                        <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                            読む <span className="group-hover:translate-x-1 transition-transform">→</span>
                        </span>
                    </Link>
                ...
                <Link href="/health-check-guide"
                    ...
                    <p className="text-sm text-[#1A1A1A]/80 leading-relaxed mb-2 line-clamp-3 sm:line-clamp-none">A・B判定だけで終わらせず、経年変化と関連項目をつなぎ、再検査・受診まで行動に変える。</p>
                    <span className="inline-flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-bold text-[#1A1A1A] bg-[#FF9855]">見る <span className="group-hover:translate-x-1 transition-transform">→</span></span>
                </Link>
