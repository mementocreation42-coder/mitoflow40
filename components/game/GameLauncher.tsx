...
export function PhoneFrame({ children }: { children: ReactNode }) {
    return (
        <div className="rounded-[36px] border-[6px] border-[#1A1A1A] bg-[#1A1A1A] shadow-2xl overflow-hidden" style={{ width: 'min(400px, calc(100vw - 32px), calc((100dvh - 96px) * 390 / 640))' }}>
