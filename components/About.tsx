            ...
            <div className="max-w-[1000px] mx-auto px-4 relative z-10">
                ...
                <div className="grid gap-8">
                    ...
                    <div className="space-y-6 text-[#1A1A1A] bg-white/30 backdrop-blur-sm p-6 rounded-xl">
                        <p>
                            私たちの体には、エネルギーを生み出す「ミトコンドリア」が存在します。<br />
                            しかし、40代を境にその機能は低下し、疲労や活力不足の原因となります。
                        </p>
                        <p>
                            MitoFlow40は、ミトコンドリアを起点に「食事・運動・習慣・サプリ」の4本柱でカラダの流れを整える健康戦略です。<br />
                            一過性の対策ではなく、今の自分を正しく整える知恵と技術で、暮らしを再設計する。<br />
                            流れが整えば、人生は再び劇的な変化を遂げ始めます。
                        </p>
                    </div>
                </div>
            </div>
